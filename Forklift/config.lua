...
Config.Blips = false -- Enable blips on the map
...
Config.PayScales = {
	...
	bonus3 = 350, -- Bonus payout if the pallet is below 1000 health but higher than 750
...
Config.Locations = {
	[1] = {
		['Start'] = {
			ped = `s_m_y_airworker`,
			coords = vector3(90.32, 6340.37,30.38), -- Where the player can take orders vector4(153.81, -3214.6, 5.93, 87.71)
			heading = 87.71,
		...
		['Garage'] = { -- Garage settings
			...
			coords = vector3(85.89, 6344.96, 30.38), 
			heading = 116.0,
			scenario = 'WORLD_HUMAN_AA_COFFEE',
			['Spawn'] = {
				coords = vector3(80.26, 6340.9, 31.23),
				heading = 269.27
		...
		['Pickup'] = { -- Pickup settings ~~ I wouldn't change the vehicle as the function for finding the back is only setup for the benson ~~
			...
			ped = `ig_talmm`,
			['Spawn'] = {
				coords = vector3(2.74, 6266.08, 31.36),
				heading = 296.37
			},
			['Delivery'] = {
				coords = vector3(72.71, 6341.34, 31.23),
				heading = 29.2 --81.6,
			},
		},
		['Pallets'] = { -- Pallet locations
			[1] = vector3(92.99, 6333.42, 31.38),
			[2] = vector3(90.41, 6331.98, 31.23),
			[3] = vector3(92.99, 6333.42, 31.38),
			[4] = vector3(90.41, 6331.98, 31.23),
			[5] = vector3(92.99, 6333.42, 31.38),
			[6] = vector3(90.41, 6331.98, 31.23),
			[7] = vector3(92.99, 6333.42, 31.38),
			[8] = vector3(90.41, 6331.98, 31.23)
		},
	...
	[2] = {
		['Start'] = {
			ped = `s_m_y_airworker`,
			coords = vector3(19.36, -2666.86, 2.78), -- Where the player can take orders
			heading = 93.33,
			scenario = 'WORLD_HUMAN_CLIPBOARD'
		},
		['Blips'] = { -- Will use these settings for each blip if Config.UniqueNames is false, just not the label
		...
		['Garage'] = { -- Garage settings
			model = `forklift`,
			ped = `s_m_y_dockwork_01`,
			coords = vector3(19.36, -2666.86, 2.78),
			heading = 12.7,
			scenario = 'WORLD_HUMAN_AA_COFFEE',
			['Spawn'] = {
